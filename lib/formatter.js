 ...
 */
const formatAsJsonString = (resultObject, _config) => {
...
const formatAsCsv = (resultObject, config) => {
  ...
  const data = _selectOutputFieldsAsArray(resultObject, fields, classifications);
...
const formatAsTable = (resultObject, config) => {
  ...
  const rows = _selectOutputFieldsAsObjects(resultObject, fields, classifications);
 ...
 */
const _selectOutputFieldsForElementAsArray = (elements, outputColumns, classification) => {
  const result = [];
 ...
 */
const _selectOutputFieldsAsArray = (resultObject, outputColumns, classifications) => {
  let result = [];
 ...
 */
const _selectOutputFieldsForElementAsObjects = (elements, outputColumns, classification) => {
  const result = [];
 ...
 */
const _selectOutputFieldsAsObjects = (resultObject, outputColumns, classifications) => {
  let result = [];
  result = result.concat(
